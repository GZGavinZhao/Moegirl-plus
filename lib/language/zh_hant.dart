...
class Language_zh_Hant extends Language_zh_Hans {
  // var note = '註釋';
  // var contribution = '貢獻';
  // var category = '分類';
  // var close = '關閉';
  ...
  // var svgImageUnsupported = '無法預覽SVG圖片';
  // var gettingImageUrl = '獲取圖片連結中...';
  // var getImageUrlErr = '獲取圖片連結失敗';
  ...
  // var articlePage_findBar_findNext = '查找下一個';
  ...
  // // 分类搜索
  // var categorySearchPage_categoryDuplicateHint = '請勿重複新增分類';
  // var categorySearchPage_categoryEmptyHint = '請選擇要搜尋的分類';

  // var categorySearchPage_appBarBody_placeholder = '搜尋分類...';
